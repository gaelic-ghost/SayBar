...
Standalone install and retained-log helper APIs in `SpeakSwiftlyServer` 12.0.0 remain outside the embedded library contract SayBar imports. They are not part of the current SayBar baseline unless the app intentionally grows a standalone-server mode.
